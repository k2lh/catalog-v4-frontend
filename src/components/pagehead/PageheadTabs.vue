    ...
    <div class="bx--grid pushed">
      <div class="bx--row">
        <div class="-col-lg-16">
          ...
          <div class="bx--tabs g90">
            <div v-for="(tab, tabindex) in tabs" :key="tabindex" class="bx--tabs-trigger" :class="{ active: tab.isActive }">
...
<style lang='scss' scoped>
  ...
  .g90 .bx--tabs-trigger a {
    color: #c6c6c6;
  }
  .g90 .bx--tabs-trigger.active a.router-link-exact-active.router-link-active {
    color: #FFF;
  }

  .g90 .bx--tabs-trigger:hover {
    color: #fff;
    color: #c6c6c6;
    background: #353535;
  }
  .g90 .bx--tabs-trigger a:hover {
    text-decoration: none;
  }
</style>
