<template>
  <div id="TimeOffer" class="page-body">
    <div class="container">
      <PageheadNoTabs :title="'Time Contribution to the Business Breakdown, by offering'" :origin="'ISA'" />
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        axios.get('https://site-' + this.shortenv + '-api.domain.net/api/timecontribution/segments-mapped').then((response) => {
          ...
          axios.get('https://site-' + this.shortenv + '-api.domain.net/api/timecontribution/segments/' + this.uniqueID).then((response) => {
            ...
            for (let i = 0; i < this.segments.length; i++) {
              if (this.maps[this.segments[i].sname] !== undefined) {
                this.segments[i].mapCount = this.maps[this.segments[i].sname].mapCount;
                this.segments[i].mapAvgBefore = this.maps[this.segments[i].sname].mapAvgBefore;
                this.segments[i].mapAvgAfter = this.maps[this.segments[i].sname].mapAvgAfter;
                this.segments[i].mapChange = this.maps[this.segments[i].sname].mapChange;
                this.segments[i].notmapCount = this.maps[this.segments[i].sname].notmapCount;
                this.segments[i].notmapAvgBefore = this.maps[this.segments[i].sname].notmapAvgBefore;
                this.segments[i].notmapAvgAfter = this.maps[this.segments[i].sname].notmapAvgAfter;
                this.segments[i].notmapChange = this.maps[this.segments[i].sname].notmapChange;
              }
            }
          });
        });
